...
#include "OasisCameraProxy_InitializeCameraViewWithPivotInfo.generated.h"

UCLASS()
class UOasisCameraProxy_InitializeCameraViewWithPivotInfo : public UOasisCameraProxyBase
{
	GENERATED_BODY()
public:
